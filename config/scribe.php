...
use App\Modules\Core\Scribe\Strategies\GetMetadataFromQueryBuilder;
use App\Modules\Core\Scribe\Strategies\GetQueryParamsFromQueryBuilder;
...
return [
    ...
    'description' => 'REST API для управления пользователями, контактами, верификациями и ролями.',
    ...
    'strategies' => [
        'metadata' => [
            ...
            GetMetadataFromQueryBuilder::class,
        ],
        'headers' => [
        ...
        'queryParameters' => [
            ...
            GetQueryParamsFromQueryBuilder::class,
        ],
        'bodyParameters' => [
